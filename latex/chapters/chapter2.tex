...
Finally, Metal-Oxide-Semiconductor (MOS) junctions represent another possibility to build a detector. An example are Charged Coupled Devices (CCDs)

\fix{Poi parliamo delle ccd. Non so bene come introdurle perchè non voglio parlare dei MOS perchè non ne so nulla, ma bisogna almeno citarli perchè le CCD sono sia pn che MOS.}

\fix{Infine introduciamo il concetto di hybrid pixel detectors}
