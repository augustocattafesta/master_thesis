...
\begin{equation}
d \simeq \sqrt{\frac{2\epsilon \epsilon_0}{N_D e} V_{bi}},
\label{eq:dep_zone}
\end{equation}
...
\begin{equation}
d_{n,p} \simeq \sqrt{\frac{2\epsilon \epsilon_0}{N_{D, A} e} (V_{bi} + V_{ext})},
\label{eq:dep_zone}
\end{equation}
...
\fix{qui descriviamo il funzionamento di un detector a semiconduttore, con le varie proprietà, e descriviamo anche il funzionamento delle giunzioni, in particolare pn e schottky. parliamo anche della diffusione della carica all'interno del sensore. Porterei come esempi il detector SSS a bordo di Einstein (p-i-n) Si(Li), poi le CCD}
