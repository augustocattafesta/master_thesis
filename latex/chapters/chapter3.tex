...
\fix{descrivere un po meglio il concetto di GPD dagli articoli di ronaldo e parlare un po piu di IXPE.}
...
The GPD ASIC \cite{bellazzini2004, bellazzini2006}, named XPOL-I, which is the first generation of the XPOL familiy, is responsible for the collection of charges produced by the GEM during the multiplication stage, acting as the readout anode.
