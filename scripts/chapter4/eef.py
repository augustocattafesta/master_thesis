...
plt.plot(x, eef50_eta_nomc, "-.k", label=r"$\eta$-function (no MC)")
plt.plot(x, eef50_eta_mc, ":k", label=r"$\eta$-function (MC)")
...
plt.plot(x, eef90_eta_nomc, "-.k", label=r"$\eta$-function (no MC)")
plt.plot(x, eef90_eta_mc, ":k", label=r"$\eta$-function (MC)")
plt.xlabel(r"$\langle \sigma \rangle / p$ [%]")
